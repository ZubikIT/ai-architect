...
| [`kurs/`](kurs/README.md) | **Сквозной разбор курса**: [полный](kurs/kurs-polnyy.md) (идея урока → где применено → что показал замер, шесть расхождений курса с замером), [выжимка на страницу](kurs/kurs-kratko.md) и [программа своего курса для LMS](kurs/lms-syllabus.md) |
