...
| [`kurs/`](kurs/README.md) | **Сквозной разбор курса**: [полный](kurs/kurs-polnyy.md) (идея урока → где применено → что показал замер, шесть расхождений курса с замером) и [выжимка на страницу](kurs/kurs-kratko.md) |
