...
- [ ] [30. Ethical AI by Design и архитектура для Governance](./30-ethical-ai-governance/30-ethical-ai-governance.md) — Responsible AI, 4 слоя governance, Decision Log, Model Card — **ДЗ-капстоун блока 6:** [`Zubik_DZ-30`](./30-ethical-ai-governance/Zubik_DZ-30_finops-governance.md) (Model Card + FinOps-отчёт; уроки 28 + 30, дедлайн 27.08)
