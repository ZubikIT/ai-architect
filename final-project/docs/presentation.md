...
> **Как пользоваться файлом.** Слайд = блок между `---`. Строка «💬» — реплика докладчику, на слайд не выносится. Сборка: `./scripts/md-to-slides.sh final-project/docs/presentation.md`. Хронометраж: 52 слайда ≈ 30 минут. **Регламент защиты — 5 минут**, поэтому выступление идёт по `presentation-5min.md` (12 слайдов), а эта дека — резерв на вопросы.
