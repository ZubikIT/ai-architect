...
💬 Ранжирование в обоих случаях ставит отменённый пункт первым — он ближе по словам. Никакая нарезка этого не чинит. Спрос на класс B по логам не виден: пользователь не формулирует его как вопрос об отмене.
