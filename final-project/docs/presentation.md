...
xychart-beta
    ...
    y-axis "Цена, $" 0 --> 20
    bar [17.78, 8.89, 3.56, 1.78, 0.89]
    line [2, 2, 2, 2, 2]
```

Линия — **потолок коридора внешнего вендора** ($0,3–2 за 1M выходных). Разброс собственной цены **двадцатикратный**: в коридор она входит между 25 % и 50 % утилизации.
...
> 103 теста · 28 ADR · 5 отчётов с цифрами · **три отрицательных результата, оставленных как есть**

Отрицательные: мультиагентный слой не дал прироста качества · чужая цифра, взятая без проверки · рекомендация собственного отчёта оказалась не той.
