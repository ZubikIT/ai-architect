...
- **нет запасного пути при отказе сервиса ранжирования** — запрос падает, и это осознанно: молчаливый откат тихо выключил бы порог отказа
- **чанк не несёт свой адрес в тексте** — вторая половина вывода пилота (+22 п.п. hit@1) не сделана
