...
> **Как пользоваться файлом.** Версия на регламент **5 минут**: 12 слайдов. Строка «💬» — это дословная реплика с хронометражем, на слайд не выносится. Полная дека `presentation.md` (51 слайд) остаётся резервом на вопросы. Сборка: `./scripts/md-to-slides.sh final-project/docs/presentation-5min.md`.
