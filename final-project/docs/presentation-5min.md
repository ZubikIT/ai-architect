...
> **Как пользоваться файлом.** Версия на регламент **5 минут**: 12 слайдов. Строка «💬» — это дословная реплика с хронометражем, на слайд не выносится. Полная дека `presentation.md` (39 слайдов) остаётся резервом на вопросы. Сборка: `./scripts/md-to-slides.sh final-project/docs/presentation-5min.md`.
...
Железо **арендовано** — 1 200 BYN/мес, всё включено. **TCO ≈ $29,4k / 3 года**, три четверти — ФОТ. Порог окупаемости против вендора — **31 % утилизации**.

**Утилизация измерена за 30 дней: 0,9 %.** Фактическая цена 1M выходных токенов — **$142**, а не $0,61. На этом трафике контур не окупается по цене токена: покупается юрисдикция.

💬 **[3:44 → 4:16]** Вопрос «не тормозит ли ваш GraphRAG» закрыт цифрой: граф — три десятых процента. Время съедали генерация и реранк, и свой реранкер уехал в сервис платформы: на восьми клиентах в шесть раз больше RPS, но важнее, что узкое место сменило природу — из моих ядер в ожидание сети. В экономике решает утилизация, и её я измерил: ноль целых девять десятых процента за тридцать дней. Порог окупаемости — тридцать один процент, то есть мы в тридцать четыре раза ниже. Реальная цена миллиона токенов — сто сорок два доллара против двух у вендора. Контур покупается ради юрисдикции, а не ради цены, и говорить «дешевле облака» я не имею права.
