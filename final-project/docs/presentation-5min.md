...
💬 **[3:44 → 4:16]** Вопрос «не тормозит ли ваш GraphRAG» закрыт цифрой: граф — три десятых процента. Время съедали генерация и реранк, и свой реранкер уехал в сервис платформы: на восьми клиентах в шесть раз больше RPS, но важнее, что узкое место сменило природу — из моих ядер в ожидание сети. В экономике решает утилизация, и её я измерил: ноль целых девять десятых процента за тридцать дней. Порог окупаемости после смены модели — около семидесяти процентов: сервер держит двадцать четыре запроса вместо девяноста шести, то есть мы в семьдесят восемь раз ниже. Реальная цена миллиона токенов — сто сорок два доллара против двух у вендора. Контур покупается ради юрисдикции, а не ради цены, и говорить «дешевле облака» я не имею права.
