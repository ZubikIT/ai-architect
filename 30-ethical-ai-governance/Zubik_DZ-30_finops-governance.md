...
**Что мы не можем измерить на этом уровне:** долю дословно запоминаемых фрагментов правового корпуса (memorization) — специальный тест на извлечение не проводился; и качество на редких отраслях права, не представленных в eval-наборе пропорционально.
...
| **Memorization test** (извлечение фрагментов обучающего корпуса из адаптера) | не более единичных совпадений | **не проводился** | ❌ пробел, см. § 1.6 |
...
| **Запоминание авторского контента весами** — 88 % корпуса составляют аналитические статьи ilex (авторский материал), и при однократном проходе возможно дословное запоминание фрагментов | **Высокая** (юридическая, не приватности) | тест на memorization перед внешней публикацией весов; при подтверждении — публикация только квантованного GGUF либо ограничение доступа. **Важно: на кодексы и иные НПА (12 % корпуса) риск не распространяется** — официальные акты не являются объектом авторского права. Во внутреннем контуре риск не реализуется |
