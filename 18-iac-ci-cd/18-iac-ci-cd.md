...
>
> Артефакты: [слайды лекции](artifacts/lesson-18-iac-cicd.pdf) (31 стр.) · практика: [NickOsipov/otus-mlops-terraform-nov](https://github.com/NickOsipov/otus-mlops-terraform-nov) (live-деплой VM + VPC + SA + S3 в Yandex Cloud) · [Ilia2704/llm-app](https://github.com/Ilia2704/llm-app) (приложение из урока 13 как объект CI/CD).
>
