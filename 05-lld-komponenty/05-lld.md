...
Продолжаем БФТ-кейс из урока 2 — голосовой AI-ассистент для исходящего обзвона клиентов отеля по бронированиям (заказчик — ООО «Ежики-иголки»). Конспект ТЗ: [`../../01-strategy/artifacts/lesson-02-bft-primer-sufler.docx`](../02-proektirovanie-i-ocenka/artifacts/lesson-02-bft-primer-sufler.docx).
